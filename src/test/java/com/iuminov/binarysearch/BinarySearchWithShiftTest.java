...
import static com.iuminov.binarysearch.BinarySearchWithShift.find;
import static org.junit.Assert.*;

@RunWith(JUnit4.class)
public class BinarySearchWithShiftTest {
    private int[] array;

    @Before
    public void init() {
        array = new int[] {11, 14, 17, 1, 5, 6, 9, 10};
    }
    ...
    public void testBinarySearchHappyPathThirdElement() {
        ...
        int actualResult = find(17, array);
